...
class TestPathFinder:
    ...
    def test_process_path_success(self):
        ...
        success, path = pf.process_path([1, 2, 3], total_paths=99)
        assert success is True
        assert path == [1, 2, 3]
        assert success_handler.called_paths == [[1, 2, 3]]
